...
const k8sDefaultTerminationGracePeriod = 30 * time.Second

type (
	// HTTPServer is an abstraction of something that listens for connections an do HTTP things. 99% of the time, you'll pass in a net/http/Server.
...
// ListenAndServe will call the ListenAndServe function of the delegate HTTPServer you passed in at construction.
// On a signal being sent to the shutdown signal provided in the constructor,
// it will call the server's Shutdown method to attempt to gracefully shutdown.
