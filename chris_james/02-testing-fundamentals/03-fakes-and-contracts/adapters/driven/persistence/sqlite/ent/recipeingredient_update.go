...
func (riu *RecipeIngredientUpdate) SetNillableQuantity(i *int) *RecipeIngredientUpdate {
	if i != nil {
		riu.SetQuantity(*i)
	}
	return riu
...
// SetNillableQuantity sets the "quantity" field if the given value is not nil.
func (riuo *RecipeIngredientUpdateOne) SetNillableQuantity(i *int) *RecipeIngredientUpdateOne {
	if i != nil {
		riuo.SetQuantity(*i)
	}
	return riuo
